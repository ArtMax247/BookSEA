...
<body>
    ...
    <div class="manage-account-container">
		<div class="site-name">Update Password</div>
        <form action="updateUser" method="post">
           ...
           <div class="form-field">
            	<button type="button" onclick="window.location.href='readBook'">Back to Home</button>
        	</div>
            <% if ("true".equals(request.getParameter("error"))) { %>
                <p class="message error">Invalid password or passwords do not match</p>
            <% } %>
            <% if ("false".equals(request.getParameter("error"))) { %>
                <p class="message success">Password Updated</p>
            <% } %>
        </form>
    </div>
    </div>
